"""
thoracentesis: 胸腔穿刺术 Scoring Plugin
"""
import numpy as np
...
class SkillScorer:
    def __init__(self, config=None):
        ...
        self.skill_name = "thoracentesis"
        self.landmark_history = {}
        self.feature_cache = {}
    def extract_features(self, landmarks):
        f = {}
        ls = self._lm(landmarks, "left_shoulder"); rs = self._lm(landmarks, "right_shoulder")
        rw = self._lm(landmarks, "right_wrist"); lh = self._lm(landmarks, "left_hip")
    ...
    def get_feedback(self, metrics, features):
        ...
        if ia < 70 or ia > 110: fb.append({"type":"critical","message":"进针角度异常，应接近90垂直","severity":"critical","metric":"angle_score"})
